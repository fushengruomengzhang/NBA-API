import{_ as c,s as g,a as S}from"./index.CbOEeOhL.js";import{o as p,k as u,a as s,w as d,r as i}from"./vendor.Btyi1dAR.js";import"./async.component.20260917.js";import"../../public.scmp.config.js";const h=""+new URL("../png/request_detail.CJkkbxgZ.png",import.meta.url).href,m=""+new URL("../png/api_doc_detail.DueNsqIJ.png",import.meta.url).href,T=""+new URL("../png/task_handler_detail.BzVmVNPY.png",import.meta.url).href,N=""+new URL("../png/setting_ai_detail.DlnPfu0j.png",import.meta.url).href,b=""+new URL("../png/chat_detail.lVz80ktR.png",import.meta.url).href,l=`<div class='title'>NBA-API 使用手册（完整版）</div>

> 浏览器端团队 API 平台：**测接口、写文档、定时调度、AI助手、群聊** 一体。  
> 左侧帮助目录与侧栏模块同序：API → Swagger 管理 → 组合文档 → 定时 → **AI助手** → **群聊** → 配置。
...
| **配置**         | 用户名与角色、**AI 密钥 / 本地 Base-Url**<br>全局 Header、远程/本地域名、PluginReq、自动保存          |
...
> 用户名与角色、**AI 信息（密钥 / 本地地址）**、全局执行次数、全局 Header、远程/本地域名、PluginReq、自动保存集中在齿轮；  
...
![侧栏 AI 助手抽屉](./img/setting_ai_detail.png)
...
3. **环境与协作不卡脖子** — PluginReq 测本机 localhost；  
   齿轮配 AI 密钥（仅本机）；侧栏 **AI助手** 与 **群聊** 同级入口，需要时再上群

**适合：** 后端维护接口库、前端按文档联调、测试巡检与批量执行、  
小团队在线对齐与 AI 辅助。
`,f={"./img/request_detail.png":h,"./img/api_doc_detail.png":m,"./img/task_handler_detail.png":T,"./img/setting_ai_detail.png":N,"./img/chat_detail.png":b},_={urlMapping:f,_is_md:!0,toJSON:()=>l,toString:()=>l,valueOf:()=>l},C={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[_]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(a){const n=this.el.querySelector(`[data-tree-id='${a.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let a=[],n=[],A=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,P)=>{const e=parseInt(o.tagName.slice(1),10),r=g("dti_");o.setAttribute("data-tree-id",r);const t={id:++A,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(t.pid=n[n.length-1].id),n.push({...t,level:e}),a.push(t)}),this.folders=S(a,"id","pid")}}},w={class:"nba-api-doc"};function H(a,n,A,o,P,e){const r=i("el-tree"),t=i("s3-scroll"),I=i("s3-doc");return p(),u("div",w,[s(t,{class:"folder"},{default:d(()=>[s(r,{data:P.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(t,null,{default:d(()=>[s(I,{ref:"docWrapper",class:"wrapper_detail",unUseNum:"",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const W=c(C,[["render",H],["__scopeId","data-v-a95b9845"]]);export{W as default};
